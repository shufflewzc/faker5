    ...
    async getUserInfo() {
        const options = {
            ...
            'headers': {
                ...
                'User-Agent': 'Mozilla/5.0 (Linux; Android 9; vivo X21A Build/PKQ1.180819.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/68.0.3440.91 Mobile Safari/537.36 AgentWeb/5.0.8  UCBrowser/11.6.4.950',
                'sec-ch-ua': '"Android WebView";v="125", "Chromium";v="125", "Not.A/Brand";v="24"',
                'sec-ch-ua-mobile': '?1',
                'sec-ch-ua-platform': '"Android"',
                'x-qzm-aid': `|${this.oaid}|${this.androidId}`,
                'x-qzm-bundle': 'com.zhangwen.quzanmi|vivo|9|1.0.1',
